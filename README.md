...
팀원 모두 공개소프트웨어실습 과목을 수강하며 오픈소스 기여방법 및 오픈소스 개발 시 고려사항 등 오픈소스기여에 필요한 지식을 배웠습니다. 또한 직접 미니스피드게임을 만들어 오픈소스에 추가하고 기존에 존재하는 게임의 다른 언어 버전을 만들어 기여하는 등의 과정을 통해 성취감을 느꼈고 오픈소스기여에 대한 흥미가 커지게 되었습니다.  
오픈소스 사용 조건이나 의무사항을 준수했는지 등을 검증해주는 도구인 FOSSLight을 사용하면 개발할 때 시간을 많이 줄일 수 있고 위험성을 방지할 수 있을 것 같다는 생각이 들었습니다. 저희도 FOSSLight을 사용할 개발자로서 직접 FOSSLight으로 오픈소스 기여를 해보면서 추후 변경하면 좋을 점을 찾아내고 기여해봄으로써 저희에게도 좋은 기회와 경험이 될 것 같아 신청하게 되었습니다. 저희가 FOSSLight 오픈소스 기여에 참여하게된다면 열과 성의를 다해 참여하도록 하겠습니다!

- 우리 팀이 잘 할 수밖에 없는 이유
 1. 같은 팀원으로 팀프로젝트를 여러번 수행하여 **팀워크**가 좋고 **의사소통**이 원활합니다.
 2. 학교에서 열리는 행사에 꾸준히 참여하는 **성실함**과 배우고자 하는 열정을 가지고 있습니다.
 3. 새로운 언어를 배움에 거침없고 **적극적인 자세**를 가지고 있습니다.
...
오픈소스 사용을 위해서는 각 오픈소스의 라이선스 규정, 저작권, 의무사항을 반드시 지켜야 하기에 이를 관리하는 sw가 굉장히 중요하다고 생각합니다. 이번 FOSSLight 개발팀에 참여하여 기여를 하게 된다면 큰 책임감을 가지고 열정적으로 재미있게 활동을 함께 해보고 싶습니다. 감사합니다.
...
**자기소개**  
저는 웹, 앱 개발에 대한 흥미가 있어 다양한 경험을 통해 관련지식을 배워나가려고 노력하는 학생입니다.  이러한 지식을 바탕으로 3학년 때는 주어진 요구사항에 맞는 웹사이트를 개발하고 cloud를 사용하여 배포하는 WNC 프로그래밍 대회를 운영하고 평가하였으며 이 과정에서 여러 오픈소스의 적용을 보았으며 오픈소스의 중요성을 느꼈습니다. 또한 공개소프트웨어실습 전공을 수강하여 파이썬 게임을 개발하고 이를 오픈소스화하는 과정, 게임 오픈소스에 기여하는 과정을 통해 오픈소스 기여에 재미를 느끼고 이후에도 개인적으로 이 활동을 이어나가고 있습니다. 이러한 저의 관심을 FOSSLight 개발팀에서 보여드릴 수 있도록 팀원들과 함께 이 프로젝트에 참여하고싶습니다!

**관심분야**
: `frontend` `backend` `Android 앱`
