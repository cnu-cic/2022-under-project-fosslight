...
팀원 모두 공개소프트웨어실습 과목을 수강하며 오픈소스 기여방법 및 오픈소스 개발 시 고려사항 등 오픈소스기여에 필요한 지식을 배웠습니다. 또한 직접 미니스피드게임을 만들어 오픈소스에 추가하고 기존에 존재하는 게임의 다른 언어 버전을 만들어 기여하는 등의 과정을 통해 성취감을 느꼈고 오픈소스기여에 대한 흥미가 생겼습니다.  
